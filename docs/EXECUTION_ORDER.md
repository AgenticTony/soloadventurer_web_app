...
- ✅ **PHASE_W (step 9c) — W.2 / W.3 / W.4 complete 2026-08-13** (web PRs #28/#29/#30/#31). W.2's typed client surfaced **four phantom-*column* bugs live in prod** — the class `check-schema-refs.py` cannot see, because it checks table and RPC names, not columns. **Remaining: Tailwind 3→4, `date-fns` v4.**
