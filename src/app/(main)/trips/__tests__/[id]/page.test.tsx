...
const mockTrip = {
  ...
  description: 'Discovering the magic of Paris with friends',
...
describe('TripDetailPage', () => {
  ...
  it('should render trip details when loaded successfully', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTestId('trip-detail')).toBeInTheDocument()
      expect(screen.getByText('Trip: Paris Adventure')).toBeInTheDocument()
    })
  ...
  it('should navigate back to trips when back button clicked', async () => {
    ;(getTrip as jest.Mock).mockResolvedValue(mockTrip)
