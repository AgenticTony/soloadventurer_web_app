  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-foreground">Help & Support</h1>
          <p className="text-lg text-muted-foreground">Get answers and reach out to the team</p>
        </div>
        ...
        <div className="card-base mx-auto max-w-lg p-12 text-center">
          ...
          <h2 className="mb-3 text-2xl font-bold text-foreground">Need a hand?</h2>
          <p className="mb-6 text-muted-foreground">
            We&apos;re a small team building SoloAdventurer for solo travelers like you. Drop us a
