...
const mockCreateTypingDebounce = chatApi.createTypingDebounce as jest.MockedFunction<
  typeof chatApi.createTypingDebounce
>
const mockSubscribe = chatApi.subscribeToTypingIndicators as jest.MockedFunction<
  typeof chatApi.subscribeToTypingIndicators
>
...
describe('useTypingIndicator', () => {
  ...
  it('cleans up and re-subscribes when connectionId changes', () => {
    ...
    mockCreateTypingDebounce.mockReturnValueOnce(debounce1).mockReturnValueOnce(debounce2)
