...
import { createTypingDebounce, subscribeToTypingIndicators, type TypingEvent } from '@/lib/api/chat'
...
export function useTypingIndicator({
  ...
  useEffect(() => {
    ...
    const unsub = subscribeToTypingIndicators(connectionId, userId, (event: TypingEvent) => {
