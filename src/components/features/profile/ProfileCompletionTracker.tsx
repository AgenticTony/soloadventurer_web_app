...
export function ProfileCompletionTracker() {
  ...
  const getCompletionLevel = () => {
    if (completionPercentage >= 80) return { level: "Expert", color: "text-green-600", bgColor: "bg-green-100" }
    if (completionPercentage >= 60) return { level: "Advanced", color: "text-blue-600", bgColor: "bg-blue-100" }
    if (completionPercentage >= 40) return { level: "Intermediate", color: "text-yellow-600", bgColor: "bg-yellow-100" }
    if (completionPercentage >= 20) return { level: "Beginner", color: "text-orange-600", bgColor: "bg-orange-100" }
