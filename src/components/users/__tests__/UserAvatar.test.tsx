...
describe('UserAvatar', () => {
  ...
  it('should render status indicator when showStatus is true', () => {
    render(<UserAvatar user={mockUser} status="online" showStatus={true} />)
  ...
  it('should render different status colors', () => {
    const { rerender } = render(<UserAvatar user={mockUser} status="online" showStatus={true} />)
  ...
  it('should not render status indicator when showStatus is false', () => {
    render(<UserAvatar user={mockUser} status="online" showStatus={false} />)
