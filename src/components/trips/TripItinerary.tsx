            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <select
                  value={newItem.type}
                  onChange={e =>
                    setNewItem(prev => ({ ...prev, type: e.target.value as ItineraryItem['type'] }))
                  }
      ...
      <div className="space-y-3">
        {sortedItems.length === 0 ? (
          <div className="py-8 text-center text-gray-500">
            ...
            {editable && <p className="text-sm">Add your first item to get started</p>}
          </div>
        ) : (
                      ...
                      <div className="mb-2 flex items-start justify-between gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          {isEditing ? (
                            ...
                            <h4
                              className={`text-base font-medium ${item.completed ? 'text-gray-500 line-through' : ''}`}
                            >
                              {item.title}
                            </h4>
                          )}
