...
export function TravelMap({ locations, className = '' }: TravelMapProps) {
  return (
    <div
      className={`relative h-full min-h-[400px] w-full overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 ${className}`}
    >
      ...
      {locations.map((location, index) => (
        ...
        >
          <motion.div whileHover={{ scale: 1.2 }} className="group relative cursor-pointer">
            <motion.div
              ...
              style={{ opacity: 0.3 }}
            />
            <div className="relative rounded-full bg-gradient-to-br from-blue-500 to-purple-600 p-2 shadow-lg">
